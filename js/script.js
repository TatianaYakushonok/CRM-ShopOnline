...
const createRows = ({ id, title, category, units, count, price }) => {
  ...
  tdBtn.classList.add('table__ceil', 'table__ceil_btn');
  const btnImg = document.createElement('button');
  btnImg.classList.add('table__btn');
  btnImg.type = 'button';
  btnImg.innerHTML = `
  ...
  btnEdit.classList.add('table__btn');
  btnEdit.type = 'button';
  btnEdit.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" width="20"
      height="20" viewBox="0 0 20 20" fill="none">
  ...
  btnDel.classList.add('table__btn');
  btnDel.type = 'button';
  btnDel.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" width="20"
      height="20" viewBox="0 0 20 20" fill="none">
  ...
  `;
  tdBtn.append(btnImg, btnEdit, btnDel);
